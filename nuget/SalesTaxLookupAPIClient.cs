...
namespace APIVerve.API.SalesTaxLookup
{
    ...
    /// <summary>
    /// Client for the SalesTaxLookup API
    /// </summary>
    public class SalesTaxLookupAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/salestax";
        ...
        public SalesTaxLookupAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SalesTaxLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SalesTaxLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, SalesTaxLookupQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(SalesTaxLookupQueryOptions options)
        {
        ...
        public ResponseObj Execute(SalesTaxLookupQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(SalesTaxLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(SalesTaxLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(SalesTaxLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(SalesTaxLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(SalesTaxLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(SalesTaxLookupQueryOptions options)
        {

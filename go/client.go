// Package salestax provides a Go client for the Sales Tax Lookup API.
//
// For more information, visit: https://apiverve.com/marketplace/salestax?utm_source=go&utm_medium=readme
package salestax
...
const (
	baseURL        = "https://api.apiverve.com/v1/salestax"
	defaultTimeout = 30 * time.Second
)

// Client is the Sales Tax Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Sales Tax Lookup API client.
...
// Execute makes a request to the Sales Tax Lookup API with typed parameters.
//
...
//   - zip (required): string - The zip code for which you want to get the sales tax rate [minLength: 5, maxLength: 5]

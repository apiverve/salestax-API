...
```gradle
dependencies {
    implementation 'com.github.apiverve:salestax-api:1.1.14'
}
```
...
```java
import com.apiverve.salestax.SalesTaxLookupAPIClient;
import com.apiverve.salestax.APIResponse;
import com.apiverve.salestax.APIException;

// Initialize the client
SalesTaxLookupAPIClient client = new SalesTaxLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("zip", "64082");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/salestax](https://docs.apiverve.com/ref/salestax)
...
- **Documentation:** [https://docs.apiverve.com/ref/salestax](https://docs.apiverve.com/ref/salestax)
- **Issues:** [GitHub Issues](https://github.com/apiverve/salestax-api/issues)
